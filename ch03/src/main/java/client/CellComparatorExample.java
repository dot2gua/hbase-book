...
public class CellComparatorExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        put1.add(Bytes.toBytes("fam-1"), Bytes.toBytes("qual-1"), Bytes.toBytes("val-1"));
        Put put2 = new Put(Bytes.toBytes("row-2"));
        put2.add(Bytes.toBytes("fam-1"), Bytes.toBytes("qual-2"), Bytes.toBytes("val-2"));
        Put put3 = new Put(Bytes.toBytes("row-3"));
        put3.add(Bytes.toBytes("fam-2"), Bytes.toBytes("qual-3"), Bytes.toBytes("val-3"));
        Put put4 = new Put(Bytes.toBytes("row-1"));
        put4.add(Bytes.toBytes("fam-2"), Bytes.toBytes("qual-2"), Bytes.toBytes("val-2"));
