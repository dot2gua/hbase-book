...
public class BatchCallbackExample {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    put.add(COLFAM2, QUAL1, 4, Bytes.toBytes("val5")); // co BatchCallbackExample-2-AddPut Add a Put instance.
    batch.add(put);
    ...
    delete.deleteColumns(COLFAM1, QUAL2); // co BatchCallbackExample-4-AddDelete Add a Delete instance.
    batch.add(delete);
